...
class CustomElasticsearchConnector:
    ...
    def __init__(
        ...
        connections.create_connection(
            hosts=hosts, api_key=api_key, verify_certs=verify_certs, ssl_show_warn=False
        )
    ...
    async def get_all_flows(
        ...
        return await _get_all_flows(
            self, view=view, size=size, include_pcap=include_pcap, flow_id=flow_id
        )
        ...
        async def _legacy_get_all_flows(self, onlyunseen, size):
            ...
            async with AsyncElasticsearch(
                ...
                if size:
                    if onlyunseen:
                        s = (
                            AsyncSearch(using=client, index=INDEX_NAME)
    ...
    async def set_flow_as_seen(self, flow_id: str):
        ...
        async with AsyncElasticsearch(
            ...
            s = AsyncSearch(using=client, index=INDEX_NAME).query(
        ...
        async with AsyncElasticsearch(
            ...
            async for hit in s:
                return await client.update(
                    ...
                    refresh="wait_for",
                    id=hit.meta.id,
                    body={"doc": {"attack_class": attack_class}},
                )
    ...
    async def save_model_properties(
        self,
        hash_value: str,
        timestamp,
        own_flow_count: int,
        score: float,
        confusion_matrix_data: dict = None,
        class_metric_data: list[list] = None,
        boxplotdata: dict = None,
    ) -> str:
        # Initialize Elasticsearch client
        async with AsyncElasticsearch(
            self.hosts,
    ...
    async def get_all_model_properties(self, size: int = 20):
        ...
        async def _get_all_model_properties(self, size):
            ...
            async with AsyncElasticsearch(
                ...
                if size:
                    s = (
                        AsyncSearch(using=client, index=MODEL_INDEX_NAME)
                        .query("match_all")
                        .extra(size=size)
                        .sort({"timestamp": {"order": "desc"}})
                    )
    ...
    async def get_model_uuid(self, hash: str) -> str:
        ...
        async with AsyncElasticsearch(
            ...
            # get from Elasticsearch
            s = AsyncSearch(using=client, index=MODEL_INDEX_NAME).query(
                "match", model_hash=hash
            )
            async for hit in s:
                return hit.meta.id
...
if __name__ == "__main__":
    ...
    cf_data = [
        {"actual": "BENIGN", "predicted": "BENIGN", "value": 1211},
        {"actual": "BENIGN", "predicted": "Bot", "value": 22},
        {"actual": "BENIGN", "predicted": "Brute Force", "value": 2},
        {"actual": "BENIGN", "predicted": "DDoS", "value": 3},
        {"actual": "BENIGN", "predicted": "DoS", "value": 15},
        {"actual": "BENIGN", "predicted": "Port Scan", "value": 4},
        {"actual": "BENIGN", "predicted": "Web Attack", "value": 2},
        {"actual": "Bot", "predicted": "BENIGN", "value": 7},
        {"actual": "Bot", "predicted": "Bot", "value": 1265},
        {"actual": "Bot", "predicted": "Brute Force", "value": 0},
        {"actual": "Bot", "predicted": "DDoS", "value": 0},
        {"actual": "Bot", "predicted": "DoS", "value": 0},
        {"actual": "Bot", "predicted": "Port Scan", "value": 1},
        {"actual": "Bot", "predicted": "Web Attack", "value": 0},
        {"actual": "Brute Force", "predicted": "BENIGN", "value": 8},
        {"actual": "Brute Force", "predicted": "Bot", "value": 0},
        {"actual": "Brute Force", "predicted": "Brute Force", "value": 1211},
        {"actual": "Brute Force", "predicted": "DDoS", "value": 0},
        {"actual": "Brute Force", "predicted": "DoS", "value": 1},
        {"actual": "Brute Force", "predicted": "Port Scan", "value": 1},
        {"actual": "Brute Force", "predicted": "Web Attack", "value": 15},
        {"actual": "DDoS", "predicted": "BENIGN", "value": 3},
        {"actual": "DDoS", "predicted": "Bot", "value": 0},
        {"actual": "DDoS", "predicted": "Brute Force", "value": 0},
        {"actual": "DDoS", "predicted": "DDoS", "value": 1236},
        {"actual": "DDoS", "predicted": "DoS", "value": 6},
        {"actual": "DDoS", "predicted": "Port Scan", "value": 0},
        {"actual": "DDoS", "predicted": "Web Attack", "value": 0},
        {"actual": "DoS", "predicted": "BENIGN", "value": 8},
        {"actual": "DoS", "predicted": "Bot", "value": 0},
        {"actual": "DoS", "predicted": "Brute Force", "value": 2},
        {"actual": "DoS", "predicted": "DDoS", "value": 7},
        {"actual": "DoS", "predicted": "DoS", "value": 1241},
        {"actual": "DoS", "predicted": "Port Scan", "value": 0},
        {"actual": "DoS", "predicted": "Web Attack", "value": 0},
        {"actual": "Port Scan", "predicted": "BENIGN", "value": 1},
        {"actual": "Port Scan", "predicted": "Bot", "value": 0},
        {"actual": "Port Scan", "predicted": "Brute Force", "value": 0},
        {"actual": "Port Scan", "predicted": "DDoS", "value": 0},
        {"actual": "Port Scan", "predicted": "DoS", "value": 1},
        {"actual": "Port Scan", "predicted": "Port Scan", "value": 1214},
        {"actual": "Port Scan", "predicted": "Web Attack", "value": 0},
        {"actual": "Web Attack", "predicted": "BENIGN", "value": 13},
        {"actual": "Web Attack", "predicted": "Bot", "value": 0},
        {"actual": "Web Attack", "predicted": "Brute Force", "value": 3},
        {"actual": "Web Attack", "predicted": "DDoS", "value": 0},
        {"actual": "Web Attack", "predicted": "DoS", "value": 6},
        {"actual": "Web Attack", "predicted": "Port Scan", "value": 1},
        {"actual": "Web Attack", "predicted": "Web Attack", "value": 1240},
    ]
    model_metrics = [
        [
            0.9680255795363709,
