...
def NEEDS_FIXING_adapt_for_retraining(data: pd.DataFrame, scaler: StandardScaler, ipca: IncrementalPCA, 
    ...
    # The trainingdata is not from Attacks! TODO fix this!!!
...
def balance_the_dataset(new_data, binary_switch=False):
    ...
    This function performs the following steps if binary switch is False:
    ...
    Args:
        ...
        binary_switch (bool): defaults to False wether the data should be 
            divided into two classes, ATTACK and BENIGN.

    Returns:
        pd.DataFrame: The balanced dataset.
    """
    # Zähle die Häufigkeit jeder Klasse TODO translate
    ...
    else:   # sample all classes to 5000
        for name in class_names:
