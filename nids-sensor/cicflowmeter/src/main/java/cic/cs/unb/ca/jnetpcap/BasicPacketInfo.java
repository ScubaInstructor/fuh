...
public class BasicPacketInfo {
    ...
    private String captureHost = "nohost";
    private String captureInterface = "nointerface";
    ...
    public String generateFlowId() {
        ...
        String[] ipPorts = forward
                ? new String[]{getSourceIP(), getDestinationIP(), String.valueOf(srcPort), String.valueOf(dstPort)}
                : new String[]{getDestinationIP(), getSourceIP(), String.valueOf(dstPort), String.valueOf(srcPort)};

        this.flowId = String.join("-", ipPorts) + "-" + protocol.val + "-" + captureHost + "-" + captureInterface;
        return this.flowId;
    }

    public String fwdFlowId() {
        this.flowId = this.getSourceIP() + "-" + this.getDestinationIP() + "-"
                + this.srcPort + "-" + this.dstPort + "-" + this.protocol.val + "-"
                + captureHost + "-" + captureInterface;
        return this.flowId;
    }

    public String bwdFlowId() {
        this.flowId = this.getDestinationIP() + "-" + this.getSourceIP() + "-"
                + this.dstPort + "-" + this.srcPort + "-" + this.protocol.val + "-"
                + captureHost + "-" + captureInterface;
        return this.flowId;
    }
    ...
    public void setCaptureInterface(String captureInterface) {
